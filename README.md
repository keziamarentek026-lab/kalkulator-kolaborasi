...
# Pendahuluan
Aplikasi Kalkulator Sederhana ini dibuat sebagai program dasar untuk membantu pengguna melakukan perhitungan aritmatika secara cepat dan praktis. Program ini dirancang untuk memproses empat operasi matematika utama, yaitu penjumlahan, pengurangan, perkalian, dan pembagian.
Selain membantu pengguna melakukan perhitungan numerik, aplikasi ini juga dikembangkan sebagai bahan pembelajaran terkait penerapan konsep dasar pemrograman, seperti penggunaan variabel, fungsi, percabangan, penanganan error, serta cara berinteraksi dengan pengguna melalui antarmuka berbasis teks.
